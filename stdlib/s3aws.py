...
class s3aws:
    ...
    _g_s3_region_baseurl = None
    _g_s3_region         = None # us-east-1
    ...
    def _set_region(self, params):
        self._g_s3_region_baseurl = params["region_baseurl"] # https://s3.amazonaws.com,https://s3-sg.amazonaws.com
        self._g_s3_region         = params["region_string" ] # us-east-1
